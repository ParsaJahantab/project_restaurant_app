...
class _Comment_ScreenState extends State<Comment_Screen> {
  ...
  Widget build(BuildContext context) {
    print(restaurant_info.getRestaurants().elementAt(0).comment_list.getComments().length);
    ...
    return Scaffold(
      ...
      body: new ListView.builder(
        ...
        itemBuilder: (BuildContext context,int index){
          print(restaurant_info.getRestaurants().elementAt(widget.res_index).comment_list.getComments().elementAt(2).comment);
          return Center(
            child: Card(
              child: Column(
